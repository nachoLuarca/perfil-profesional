...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Los siguientes mensajes de error se usan por defecto por el validador.
    | Algunos de estos contienen "placeholders" como :attribute, :min, :max, etc.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes personalizar los nombres de los campos en los mensajes.
    |
    */
    'attributes' => [
        'name' => 'nombre',
